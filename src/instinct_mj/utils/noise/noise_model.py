...
from mjlab.utils.noise import NoiseModel, NoiseModelWithAdditiveBias
...
# Scalar noise models use mjlab native implementations. Instinct-specific
# image-noise models remain as extensions below.
